import styles from '../../styles/assignment5_styles.module.css'; //imported the styles .css file 
...
function AirlineRoutes(){
    ...
    const barchart_margin = { top: 10, bottom: 50, left: 170, right: 10 };
    ...
    return <Container >
        ...
        <Row className={"justify-content-md-left"}>
        <Col lg={4}>
            <h2 className={styles.task}>Airlines</h2>
        ...
        <Col lg={4} >
            <h2 className={styles.task}>Airports</h2>
